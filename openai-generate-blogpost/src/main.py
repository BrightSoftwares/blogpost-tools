...
src_post_candidates = os.getenv('INPUT_SRC_POST_CANDIDATES') # "keyword_suggestions_merged.csv"
...
def save_post(title, content, dst_folder):
    ...
    with open(dst_folder + "/" + title + ".md", 'w') as f:
...
def collect_posts_to_generate():

  json_api_url = "https://script.google.com/macros/s/AKfycbyrolpXKu2G6cw338SsupK3cBv3u_BlQRD9_6fsnroPoL7ww_YaK73nxS5p0tVpIYiPyw/exec?channel=posts"
