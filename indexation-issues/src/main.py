...
def main():
    ...
    try:
        ...
        if critical_issues > 0:
            print(f"⚠️ Found {critical_issues} critical issues that need attention")
...
"""
    ...
    if critical_issues > 0:
        summary_content += f"- ⚠️ **{critical_issues} critical issues need immediate attention**\n"
