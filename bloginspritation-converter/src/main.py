...
def postinspiration_converter(folder, dest_folder_path, dest_lang, dry_run=False):
...
postinspiration_converter(folder, dest_folder_path, dest_lang, dry_run)
