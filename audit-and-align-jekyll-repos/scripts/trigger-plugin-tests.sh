#!/bin/bash
#
# Trigger Jekyll workflows on plugin alignment branches
# Triggers all workflows in parallel for speed
#
...
echo "=========================================="
echo "Trigger Plugin Alignment Tests"
echo "=========================================="
echo ""
...
# Wait for all parallel triggers to complete
wait
...
echo ""
echo "To re-check status, run:"
echo "  ./check-plugin-alignment-status.sh $GITHUB_TOKEN"
echo ""
