#!/bin/bash
#
# Check status of plugin alignment workflows
#
...
echo "=========================================="
echo "Plugin Alignment Status Check"
echo "=========================================="
...
if [[ $failed -gt 0 ]]; then
    echo "Failed workflows (copy URLs above and paste logs for analysis)"
fi
...
if [[ $success -eq 11 && $failed -eq 0 && $pending -eq 0 ]]; then
    echo "🎉 ALL WORKFLOWS PASSED! Ready to merge branches."
fi
